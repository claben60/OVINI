    ...
    <main class="main-container">
      ...
      <section class="form-card">
        ...
        <div class="user-info-box">
          ...
          <strong>CF:</strong> <?php echo htmlspecialchars($Row["codiceFiscale"], ENT_QUOTES, 'UTF-8'); ?>
        </div>
        
        <form onsubmit="event.preventDefault(); Validate('<?php echo htmlspecialchars($Row['codiceFiscale'], ENT_QUOTES, 'UTF-8'); ?>');" style="margin-top: 20px;">
