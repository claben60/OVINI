      ...
      try
      {
        switch ($MnuAct)
        {
          ...
          case "USR":
            ...
            break;
          case "DIZ_ABIL":
            $HDRTXT = "{$SITE} <br> GESTIONE DI TUTTI I SITI <br> Dizionario Abilitazioni utenti";
            ...
            break;
          case "PROMEM":            
            $HDRTXT = "{$SITE} <br> GESTIONE DI TUTTI I SITI <br> Pro memoria";
            WriteLog("S", $FROM, $THIS_FUNCTION, $THIS_FILE, "Loading promemoria begin", NULL);
            $RetArr=GEST_SEL_Fnct($FROM,$_post);
            WriteLog("S", $FROM, $THIS_FUNCTION, $THIS_FILE, "Loading promemoriaend", NULL);
            break;
          default:  
