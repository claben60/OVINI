    ...
    <section ID="ID_GestAddSec">
      <div id="ID_GestDivAdd" class="C_GestDivAdd">
        <table id="ID_GestTblAdd" class="C_GestTblAdd"> 
          <thead>    
            <tr>      
              <th style="width:10%; text-align:left">
                <img ID="ID_AddClose" class="C_GestIcoHdr" style="text-align:left;" alt="" src="../icone/IcoRightArrow-100x100.png" onclick="GestAdd('C')">
              </th> 
              <th style="width:10%; text-align:center">
                <img class="C_GestIcoHdr" src="../icone/IcoLogo_50x50.png">
              </th>
              <th style="width:80%; text-align:left">
                 <p ID="ID_AddHdrTxt" style="height:30px; border:0;"><?php echo $SITE . " - " .$MnuAct. " -  ADD" ?></p> 
              </th>                  
             </tr>    
          </thead>  
          <tbody>
