...
{
  document.getElementById("ID_GestDivMnu").style.transition="0.5s"; /* 0.5 second transition effect to slide in the sidenav */
  if (Act=='O')
  {
    document.getElementById("ID_GestDivMnu").style.width = "80%";  
    //DoVisible("ID_ID_GestAddBtn",false);      
  }
  if (Act=='C')
  {
    document.getElementById("ID_GestDivMnu").style.width = "0%";    
