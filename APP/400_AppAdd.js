      ...
      function Add(Open,Act)
      {
        ...
        document.getElementById("ID_DivAdd").style.transition="0.5s"; /* 0.5 second transition effect to slide in the sidenav */
        if (Open=='O')
        {
          document.getElementById("ID_DivAdd").style.left = "0%";  
