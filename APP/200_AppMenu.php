...
?>
    <section>
      <div id="ID_GestDivMnu" class="C_DivMnu">
        <table id="ID_GestTblMnu" class="C_GestTblMnu"> 
          <thead> 
            <tr>      
              <th style="width:10%; text-align:center">
                <img class="C_IcoHdr" alt="" src="../icone/IcoLogo_50x50.png">
              </th>
              <th ID="ID_MnuHeader" colspan="3" style="width:80%; text-align:center"><?php echo $HDRTXT ?></th>
              <th style="width:10%; text-align: center">
                <img class="C_IcoHdr" alt="" src="../icone/IcoRimuovi-500.png" onclick="DisplayMnu('C')">
              </th>
            </tr>  
          </thead>          
          <tbody>
